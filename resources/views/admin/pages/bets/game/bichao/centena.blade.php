        ...
        <div class="row">
         ...
         <div class="row">
             <div class="col button-group overflow-auto">
                ...
                <a id="btn-group" class="btn btn-outline-primary mb-1" href="{{ route('admin.bets.bichao.index') }}"><b>{{ trans('admin.bichao.milhar') }}  </b></a>
                <a id="btn-group btn-centena" class="btn btn-primary" href="#"><b>{{ trans('admin.bichao.centena') }}</b></a>
                <a id="btn-group" class="btn btn-outline-primary mb-1" href="{{ route('admin.bets.bichao.dezena') }}"><b>{{ trans('admin.bichao.dezena') }}</b></a>
                <a id="btn-group" class="btn btn-outline-primary mb-1" href="{{ route('admin.bets.bichao.group') }}"> <b>{{ trans('admin.bichao.grupo') }}</b></a>
                <a id="btn-group" class="btn btn-outline-primary mb-1" href="{{ route('admin.bets.bichao.milhar.centena')}}"> <b>{{ trans('admin.bichao.milhcent') }} </b></a>
                <a id="btn-group" class="btn btn-outline-primary mb-1" href="{{ route('admin.bets.bichao.terno.dezena')}}"><b>{{ trans('admin.bichao.terndez') }}</b></a>
                <a id="btn-group" class="btn btn-outline-primary mb-1" href="{{ route('admin.bets.bichao.terno.grupo')}}"><b>{{ trans('admin.bichao.terngrup') }}</b></a>
                <a id="btn-group" class="btn btn-outline-primary mb-1" href="{{ route('admin.bets.bichao.duque.dezena')}}"><b>{{ trans('admin.bichao.duqdez') }}</b></a>
                <a id="btn-group" class="btn btn-outline-primary mb-1" href="{{ route('admin.bets.bichao.duque.grupo')}}"><b>{{ trans('admin.bichao.duqgrup') }}</b></a>
            </div>
        </div>
        <hr/>
        <div class="form-row">
