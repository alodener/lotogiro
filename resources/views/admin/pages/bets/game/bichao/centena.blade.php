                ...
                <div class="d-flex container align-items-center justify-content-center flex-column">
                    ...
                    <div class="">
                        <div class="input-group mb-3">
                            <textarea class="form-control" id="input-centena" rows="2" aria-describedby="basic-addon1"
                                style="resize: none;"></textarea>
                        </div>
                    </div>
                    <div class="">
                        <button id="btn-gerar-centena" onclick="insere_valor()" type="button"
                            class="btn btn-secondary">{{
                            trans('admin.bichao.gerarC') }}</button>
                    </div>
                </div>
                <div class="d-flex container align-items-center justify-content-start flex-column">
                    <div class="text-center">
                        ...
                        <a><button id="btn-award-fifth" onclick="button_fifth_award()"
                                class="btn btn-outline-primary btn-award mt-md-0 mt-1"><b>5º</b></button></a>
                        <a><button id="btn-award-first-to-fifth" onclick="button_first_to_fifth_award()"
                                class="btn btn-outline-primary btn-award mt-md-0 mt-1"><b>1º ao 5º</b></button></a>
                    </div>
                    <div class="row mt-4">
                        <div class="col">
