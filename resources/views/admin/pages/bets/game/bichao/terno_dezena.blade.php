    ...
    <div class="col bg-white p-3">
        ...
        <div class="row">
            <div class="col button-group overflow-auto">
                ...
                <a type="button" class="btn btn-primary" href="#"><b>Terno de Dezena</b></a>
                <a type="button" class="btn btn-outline-primary" href="{{ route('admin.bets.bichao.terno.grupo')}}"><b>Terno de Grupo</b></a>
                <a type="button" class="btn btn-outline-primary" href="{{ route('admin.bets.bichao.duque.dezena')}}"><b>Duque de Dezena</b></a>
