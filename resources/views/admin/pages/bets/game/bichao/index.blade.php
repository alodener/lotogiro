...
<div class="col bg-white p-3">
        ...
        <div class="row">
            ...
            <a type="button" class="btn btn-primary mb-md-0 mb-1" href="#"><b>{{ trans('admin.bichao.milhar') }}</b></a>
                 <a type="button" class="btn btn-outline-primary mb-md-0 mb-1"

                    href="{{ route('admin.bets.bichao.centena') }}"><b>{{ trans('admin.bichao.centena') }}</b></a>
                 <a type="button" class="btn btn-outline-primary mb-md-0 mb-1"

                    href="{{ route('admin.bets.bichao.dezena') }}"><b>{{ trans('admin.bichao.dezena') }}</b></a>
                 <a type="button" class="btn btn-outline-primary mb-md-0 mb-1" id="btn-group"

                    href="{{ route('admin.bets.bichao.group') }}"><b>{{ trans('admin.bichao.grupo') }}</b></a>
                 <a type="button" class="btn btn-outline-primary mb-md-0 mb-1"

                    href="{{ route('admin.bets.bichao.milhar.centena') }}"><b>{{ trans('admin.bichao.milhcent') }}</b></a>
                 <a type="button" class="btn btn-outline-primary mb-md-0 mb-1"

                    href="{{ route('admin.bets.bichao.terno.dezena') }}"><b>{{ trans('admin.bichao.terndez') }}</b></a>
                 <a type="button" class="btn btn-outline-primary mb-md-0 mb-1"

                    href="{{ route('admin.bets.bichao.terno.grupo') }}"><b>{{ trans('admin.bichao.terngrup') }}</b></a>
                 <a type="button" class="btn btn-outline-primary mb-md-0 mb-1"

                    href="{{ route('admin.bets.bichao.duque.dezena') }}"><b>{{ trans('admin.bichao.duqdez') }}</b></a>
                 <a type="button" class="btn btn-outline-primary mb-md-0 mb-1"

                    href="{{ route('admin.bets.bichao.duque.grupo') }}"><b>{{ trans('admin.bichao.duqgrup') }}</b></a>
            </div>
        </div>
        <hr />
        <div class="form-row">
