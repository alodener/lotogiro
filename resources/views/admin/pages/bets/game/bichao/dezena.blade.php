                ...
                <div class="d-flex container align-items-center justify-content-center flex-column">
                    ...
                    <div class="">
                        <div class="input-group mb-3">
                            <textarea class="form-control" id="input-dezena" rows="2" aria-describedby="basic-addon1"
                                style="resize: none;"></textarea>
                        </div>
                    </div>
                    <div class="">
                        <button id="btn-gerar-dezena" onclick="insere_valor()" type="button"
                            class="btn btn-secondary">{{
                            trans('admin.bichao.gerarD') }}</button>
                    </div>
                </div>
