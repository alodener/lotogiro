                ...
                <div class="col-md-12 indica-user">
                    <div class="card card-info pb-5">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans ('admin.qualificationBlade2.qualif') }}  </h3>
                        </div>
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="description">{{ trans ('admin.qualificationBlade2.name') }}  </label>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="goal">{{ trans ('admin.qualificationBlade2.meta') }} </label>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="personal_percentage">{{ trans ('admin.qualificationBlade2.aproveitamentoP') }}  (%)</label>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="group_percentage">{{ trans ('admin.qualificationBlade2.aproveitamentoG') }} (%)</label>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <a href="{{route('admin.settings.qualifications.index')}}">
                        <button type="button" class="btn btn-block btn-outline-secondary">{{ trans ('admin.qualificationBlade2.voltarP') }}  </button>
                    </a>
                </div>
                <div class="col-md-6 mb-3">
                    <button type="submit" class="btn btn-block btn-outline-success">{{ trans ('admin.qualificationBlade2.alter') }}  </button>
                </div>
            </div>
        </form>
    </section>
