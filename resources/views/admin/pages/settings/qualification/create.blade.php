...
@section('title', 'Nova Qualificação') 

@section('content')

<div class="col-md-12">
    <section class="content">
        <form action="{{route('admin.settings.qualifications.store')}}" method="POST">
            @csrf
            @method('POST')
                ...
                <div class="col-md-12 indica-user">
                    <div class="card card-info pb-5">
                        <div class="card-header">
                            <h3 class="card-title">{{ trans ('admin.qualificationBlade.qualif') }}  </h3>
                        </div>
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label for="description">{{ trans ('admin.qualificationBlade.name') }}   </label>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="goal">{{ trans ('admin.qualificationBlade.meta') }}   </label>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="personal_percentage">{{ trans ('admin.qualificationBlade.aproveitamentoP') }} (%)</label>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="group_percentage">{{ trans ('admin.qualificationBlade.aproveitamentoG') }}  (%)</label>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <a href="{{route('admin.settings.qualifications.index')}}">
                        <button type="button" class="btn btn-block btn-outline-secondary">{{ trans ('admin.qualificationBlade.voltarP') }} </button>
                    </a>
                </div>
                <div class="col-md-6 mb-3">
                    <button type="submit" class="btn btn-block btn-outline-success">{{ trans ('admin.qualificationBlade.cadastrar') }}  </button>
                </div>
            </div>
        </form>
    </section>
