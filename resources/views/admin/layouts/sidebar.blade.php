        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-child-indent" data-widget="treeview"
                    ...
                    <li class="nav-item nav-group-item has-treeview @if(request()->is('admin/bets/bichao*')) menu-open @endif">
                        <a href="#" class="nav-link @if(request()->is('admin/bets/bichao/*'))menu-open @endif">
