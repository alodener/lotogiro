        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="top-strip"></div>
                    ...
                    <h2 class="pb-1 text-muted">{{ trans('admin.modalOffer.sSaldo') }}</h2>
 
                     <div class="row">
                         <div class="col-sm-6">
                             <button wire:click="closeModal(0)" data-dismiss="modal" class="btn btn-warning btn-block

                                text-bold pointer-event closeOffer">{{ trans('admin.modalOffer.nJogo') }} </button>
                         </div>
                         <div class="col-sm-6">
                             <button wire:click="closeModal(1)" data-dismiss="modal" class="btn btn-primary btn-block

                                text-bold closeOffer">{{ trans('admin.modalOffer.lets') }} </button>
                         </div>
                     </div>
