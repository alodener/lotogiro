<div>
    ...
    <div class="container mt-5 d-flex card-master">
        <div class="col-md-6">
            <div class="small-box ">
                <div class="inner">
                    <h3>{{$i ?? null }}</h3>
    ...
    <div class="container mt-1 d-flex card-master">
        <div class="col-md-6">
            <div class="small-box">
                ...
                <div class="icon">
                    <i class="fas fas fa-gift" style="color:#007BFF"></i>
                </div>
                <span class="small-box-footer p-2"></span>
            </div>
        </div>
        <div class="col-md-6">
            <div class="small-box">
                ...
                <div class="icon">
                    <i class="fas fa-wallet" style="color:#CCA541"></i>
                </div>
                <span class="small-box-footer p-2"></span>
            </div>
        </div>
    ...
    <div class="container mt-1 d-flex card-master">
        <div class="col-md-12">
            <div class="small-box ">
                ...
                <div class="icon">
                    <i class="fas fa-dollar-sign" style="color:#A2D612;"></i>
                </div>
                <span class="small-box-footer p-2"></span>
            </div>
        </div>
