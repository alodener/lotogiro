    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header indica-card">
                <h3 class="card-title">{{ trans('admin.wallet') }}</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-8">
                        <h4>{{ trans('admin.balance') }}: R${{ \App\Helper\Money::toReal(auth()->user()->balance) }}</h4>
                        <h4>{{ trans('admin.bonus') }}: R${{ \App\Helper\Money::toReal(auth()->user()->bonus) }}</h4>
