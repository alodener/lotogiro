<div>
    <div class="col-md-12 p-4 faixa-jogos">
        <h3 class="text-center text-bold">{{ trans('admin.wallet.WALLET') }}</h3>
    </div>
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header indica-card">
                <h3 class="card-title">{{ trans('admin.wallet.wallet') }}</h3>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-8">
                        <h4>{{ trans('admin.wallet.balance') }} R${{ \App\Helper\Money::toReal(auth()->user()->balance) }}</h4>
                        <h4>{{ trans('admin.wallet.bonus') }}  R${{ \App\Helper\Money::toReal(auth()->user()->bonus) }}</h4>
