...
class GameV2Controller extends Controller
{
    protected $game;
    ...
    public function index(Request $request, $typeGame)
    {
        ...
        return view('admin.pages.bets.gameV2.index', compact('typeGame'));
    }
    public function carregarJogo(TypeGame $typeGame)
    {
        $typeGames = TypeGame::get();
        $clients = Client::get();
        return view('admin.pages.bets.gameV2.carregar', compact('typeGames', 'typeGame', 'clients'));
    }
    ...
    public function create(TypeGame $typeGame)
    {
        ...
        */
        ...
        return view('admin.pages.bets.gameV2.create', compact('typeGames', 'typeGame', 'clients'));
    }
    ...
    public function store(Request $request, Bet $validate_game, Game $game)
    {
        if ($request->controle == 1) {
            ...
            try {
                ...
                $game->numbers = implode(",", $request->numbers);
